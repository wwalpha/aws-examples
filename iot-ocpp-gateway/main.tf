...
module "step4-iot" {
  ...
  iot_rule_delete_thing_role_arn               = module.step1-security.iot_rule_delete_thing_role_arn
...
module "step5-app" {
  ...
  lambda_role_arn_create_thing      = module.step1-security.lambda_role_arn_create_thing
  lambda_role_arn_delete_thing      = module.step1-security.lambda_role_arn_delete_thing
  lambda_role_arn_message_processor = module.step1-security.lambda_role_arn_message_processor
  sqs_arn_incoming_message          = module.step4-iot.sqs_arn_incoming_message
  sqs_arn_delete_thing              = module.step4-iot.sqs_arn_delete_thing
}
